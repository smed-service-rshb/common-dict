...
public interface OfficesApi {
     ...
     */
    @RequestMapping(value = "/dictionaries/offices/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Office> getOffice(@PathVariable("id") Long id) throws Exception;
     ...
     * @throws Exception исключение, выбрасываемое в случае ошибок при выполнении метода
     */
    @RequestMapping(value = "/dictionaries/offices",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Page<Office>> listOffices(@PageableDefault(value = 50) Pageable pageable) throws Exception;
