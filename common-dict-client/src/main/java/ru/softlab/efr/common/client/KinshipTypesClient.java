 ...
 **/
@Component
public class KinshipTypesClient {
     ...
     */
    public KinshipTypesClient(MicroServiceTemplate microServiceTemplate) {
     ...
     * GET /dictionaries/kinshiptype
     *
     * @param timeout таймаут ожидания ответа на асинхронный запрос
     * @return Справочник видов степеней родства
     * @throws RestClientException в случае неудачи
    */
    public GetAbstractDictRs listKinshipTypes(long timeout) throws RestClientException {
        return listKinshipTypes().get(timeout);
    }

    /**
     * Справочник видов степеней родства асинхронно
     * GET /dictionaries/kinshiptype
     *
     * @return Справочник видов степеней родства
     * @throws RestClientException в случае неудачи
    */
    public ClientRestResult<GetAbstractDictRs> listKinshipTypes() throws RestClientException {
        return new ClientRestResult<>(listKinshipTypesInternal(), this::processStatusCodeErrors);
    }

    private ListenableFuture<ResponseEntity<GetAbstractDictRs>> listKinshipTypesInternal() throws RestClientException {
        

        MicroServiceURIBuilder uriBuilder = JmsUriBuilder.service(APPLICATION_NAME)
            .path(cutComments("/dictionaries/kinshiptype"));
