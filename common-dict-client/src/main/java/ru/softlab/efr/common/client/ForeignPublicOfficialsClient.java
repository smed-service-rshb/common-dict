 ...
 **/
@Component
public class ForeignPublicOfficialsClient {
     ...
     */
    public ForeignPublicOfficialsClient(MicroServiceTemplate microServiceTemplate) {
        this.microServiceTemplate = microServiceTemplate;
    }


    /**
     * Справочник видов иностранных публичных должностных лиц
     * GET /dictionaries/foreignpublicofficial
     *
     * @param timeout таймаут ожидания ответа на асинхронный запрос
     * @return Справочник видов иностранных публичных должностных лиц
     * @throws RestClientException в случае неудачи
    */
    public GetAbstractDictRs listForeignPublicOfficial(long timeout) throws RestClientException {
        return listForeignPublicOfficial().get(timeout);
    }

    /**
     * Справочник видов иностранных публичных должностных лиц асинхронно
     * GET /dictionaries/foreignpublicofficial
     *
     * @return Справочник видов иностранных публичных должностных лиц
     * @throws RestClientException в случае неудачи
    */
    public ClientRestResult<GetAbstractDictRs> listForeignPublicOfficial() throws RestClientException {
        return new ClientRestResult<>(listForeignPublicOfficialInternal(), this::processStatusCodeErrors);
    }

    private ListenableFuture<ResponseEntity<GetAbstractDictRs>> listForeignPublicOfficialInternal() throws RestClientException {
        

        MicroServiceURIBuilder uriBuilder = JmsUriBuilder.service(APPLICATION_NAME)
            .path(cutComments("/dictionaries/foreignpublicofficial"));
