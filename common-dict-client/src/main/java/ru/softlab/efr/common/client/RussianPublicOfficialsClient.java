 ...
 **/
@Component
public class RussianPublicOfficialsClient {
     ...
     */
    public RussianPublicOfficialsClient(MicroServiceTemplate microServiceTemplate) {
        this.microServiceTemplate = microServiceTemplate;
    }


    /**
     * Справочник видов российских публичных должностных лиц
     * GET /dictionaries/russianpublicofficial
     *
     * @param timeout таймаут ожидания ответа на асинхронный запрос
     * @return Справочник видов российских публичных должностных лиц
     * @throws RestClientException в случае неудачи
    */
    public GetAbstractDictRs listRussianPublicOfficials(long timeout) throws RestClientException {
        return listRussianPublicOfficials().get(timeout);
    }

    /**
     * Справочник видов российских публичных должностных лиц асинхронно
     * GET /dictionaries/russianpublicofficial
     *
     * @return Справочник видов российских публичных должностных лиц
     * @throws RestClientException в случае неудачи
    */
    public ClientRestResult<GetAbstractDictRs> listRussianPublicOfficials() throws RestClientException {
        return new ClientRestResult<>(listRussianPublicOfficialsInternal(), this::processStatusCodeErrors);
    }

    private ListenableFuture<ResponseEntity<GetAbstractDictRs>> listRussianPublicOfficialsInternal() throws RestClientException {
        

        MicroServiceURIBuilder uriBuilder = JmsUriBuilder.service(APPLICATION_NAME)
            .path(cutComments("/dictionaries/russianpublicofficial"));
