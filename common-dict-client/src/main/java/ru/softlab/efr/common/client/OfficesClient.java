...
public class OfficesClient {
     ...
     */
    public OfficesClient(MicroServiceTemplate microServiceTemplate) {
     ...
     *
     * @param id Идентификатор офиса (required)
     * @param timeout таймаут ожидания ответа на асинхронный запрос
     * @return Информация о офисе
     * @throws RestClientException в случае неудачи
    */
    public Office getOffice(Long id, long timeout) throws RestClientException {
        return getOffice(id).get(timeout);
    }

    /**
     * Возвращает информацию об офисе асинхронно
     * GET /dictionaries/offices/{id}
     *
     * @param id Идентификатор офиса (required)
     * @return Информация о офисе
     * @throws RestClientException в случае неудачи
    */
    public ClientRestResult<Office> getOffice(Long id) throws RestClientException {
        return new ClientRestResult<>(getOfficeInternal(id), this::processStatusCodeErrors);
    }

    private ListenableFuture<ResponseEntity<Office>> getOfficeInternal(Long id) throws RestClientException {
        if (id == null)
            throw new RestClientException(String.format(REQUIRED_PARAM_ERROR, "id", "getOffice"));
        

        MicroServiceURIBuilder uriBuilder = JmsUriBuilder.service(APPLICATION_NAME)
            .path(cutComments("/dictionaries/offices/{id}")).variable("id", id);

        RequestEntity requestEntity = RequestEntity
                  .method(HttpMethod.GET, uriBuilder.build())
                  .build();
        return microServiceTemplate.exchange(requestEntity,
                    new ParameterizedTypeReference<Office>(){});
    }
     ...
     * @throws RestClientException в случае неудачи
    */
    public RestPageImpl<Office> listOffices(Pageable pageable, long timeout) throws RestClientException {
        return listOffices(pageable).get(timeout);
    }

    /**
     * Список офисов асинхронно
     * GET /dictionaries/offices
     *
     * @return Постраничный вывод результатов поиска
     * @throws RestClientException в случае неудачи
    */
    public ClientRestResult<RestPageImpl<Office>> listOffices(Pageable pageable) throws RestClientException {
        return new ClientRestResult<>(listOfficesInternal(pageable), this::processStatusCodeErrors);
    }

    private ListenableFuture<ResponseEntity<RestPageImpl<Office>>> listOfficesInternal(Pageable pageable) throws RestClientException {
        

        MicroServiceURIBuilder uriBuilder = JmsUriBuilder.service(APPLICATION_NAME)
            .path(cutComments("/dictionaries/offices"));
        ...
        RequestEntity requestEntity = RequestEntity
                  ...
                  .build();
        return microServiceTemplate.exchange(requestEntity,
                    new ParameterizedTypeReference<RestPageImpl<Office>>(){});
    }
