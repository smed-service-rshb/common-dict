...
public class ChannelsClient {
     ...
     */
    public ChannelsClient(MicroServiceTemplate microServiceTemplate) {
     ...
     *
     * @param id Идентификатор канала (required)
    ...
    */
    public Channel getChannel(Long id, long timeout) throws RestClientException {
        return getChannel(id).get(timeout);
    }

    /**
     * Возвращает информацию о канале асинхронно
     * GET /dictionaries/channels/{id}
     *
     * @param id Идентификатор канала (required)
     * @return Информация о канале
     * @throws RestClientException в случае неудачи
    */
    public ClientRestResult<Channel> getChannel(Long id) throws RestClientException {
        return new ClientRestResult<>(getChannelInternal(id), this::processStatusCodeErrors);
    }

    private ListenableFuture<ResponseEntity<Channel>> getChannelInternal(Long id) throws RestClientException {
        if (id == null)
            throw new RestClientException(String.format(REQUIRED_PARAM_ERROR, "id", "getChannel"));
        

        MicroServiceURIBuilder uriBuilder = JmsUriBuilder.service(APPLICATION_NAME)
            .path(cutComments("/dictionaries/channels/{id}")).variable("id", id);

        RequestEntity requestEntity = RequestEntity
                  .method(HttpMethod.GET, uriBuilder.build())
                  .build();
        return microServiceTemplate.exchange(requestEntity,
                    new ParameterizedTypeReference<Channel>(){});
    }
     ...
     * @throws RestClientException в случае неудачи
    */
    public RestPageImpl<Channel> listChannels(Pageable pageable, long timeout) throws RestClientException {
        return listChannels(pageable).get(timeout);
    }

    /**
     * Список каналов асинхронно
     * GET /dictionaries/channels
     *
     * @return Постраничный вывод результатов поиска
     * @throws RestClientException в случае неудачи
    */
    public ClientRestResult<RestPageImpl<Channel>> listChannels(Pageable pageable) throws RestClientException {
        return new ClientRestResult<>(listChannelsInternal(pageable), this::processStatusCodeErrors);
    }

    private ListenableFuture<ResponseEntity<RestPageImpl<Channel>>> listChannelsInternal(Pageable pageable) throws RestClientException {
        

        MicroServiceURIBuilder uriBuilder = JmsUriBuilder.service(APPLICATION_NAME)
            .path(cutComments("/dictionaries/channels"));
        ...
        RequestEntity requestEntity = RequestEntity
                  ...
                  .build();
        return microServiceTemplate.exchange(requestEntity,
                    new ParameterizedTypeReference<RestPageImpl<Channel>>(){});
    }
